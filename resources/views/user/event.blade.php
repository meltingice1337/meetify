                        ...
                        <div class="col-md-4"style="margin-top:5px">
                            <ul style="list-style-type: none;margin-left:-30px">
                                ...
                                <li>
                                    ...
                                    <div class="alert alert-danger" style="margin-top:10px" role="alert">You are already participating in an event called <strong>{{ $event->isOverLapping()}}</strong> at this time.</div>
                                    @else
                                    @if(Auth::user()->events->contains($event->id))
                                    <a  href="{{route('user.event.unjoin.get', $event->id)}}" class="btn btn-primary buttonproceed" role="button">Unjoin</a>
                                    @else
                                    <a  href="{{route('user.event.join.get', $event->id)}}" class="btn btn-primary buttonproceed" role="button">Join</a>
                                    @endif
                                    @endif
                                </li>
                            </ul>
